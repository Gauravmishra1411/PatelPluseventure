...
import { Wrench, Save, UploadCloud, Palette } from "lucide-react"
      ...
      <div className="max-w-4xl mx-auto">
        <Card className="bg-card border-border">
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">Fill in the details for the new service offering.</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4 p-4 border border-border rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(value) => handleInputChange("gradient", value)}>
              ...
              <div className="flex items-center justify-end space-x-4 pt-6">
                ...
                <Button type="submit" disabled={isLoading} className="bg-primary hover:bg-primary/90">
                  {isLoading ? (<><div className="animate-spin rounded-full h-4 w-4 border-b-2 border-primary-foreground mr-2"></div>Creating...</>) : (<><Save className="w-4 h-4 mr-2" />Create Service</>)}
                </Button>
              </div>
            </form>
          </CardContent>
